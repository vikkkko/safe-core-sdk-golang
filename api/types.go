...
// SafeNoncesResponse represents multi-channel nonce information
type SafeNoncesResponse struct {
	Nonces         map[string]string `json:"nonces,omitempty"`
	DefaultChannel *int64            `json:"default_channel,omitempty"`
	// Legacy single nonce field for backward compatibility
